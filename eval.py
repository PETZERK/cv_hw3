...
if __name__ == '__main__':
    # You can change 'split' param from 'test' to 'val', and if your 'eval.py' and 'val.txt' are not in the same dir,
    # simply change it to an absolute path, e.g., Dataset_Seg(r'path to your prediction results', r'path to the
    # groundtruths', split='/data/workspace/val') (assume you have a '/data/workspace/val.txt')
    loader = Dataset_Seg(r'reference/Keras-FCN/val_result', r'reference/Keras-FCN/annotations_trainval', split='val').get_loader()
    evaluate(loader, 21)
