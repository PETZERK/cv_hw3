...
def train(batch_size, epochs, lr_base, lr_power, weight_decay, classes,
    ...
    # ################### checkpoint saver#######################
    checkpoint = ModelCheckpoint(filepath=os.path.join(save_path, 'checkpoint_weights4.hdf5'),
    ...
    model.save_weights(save_path + '/model4.hdf5')
...
if __name__ == '__main__':
    ...
    train(batch_size, epochs, lr_base, lr_power, weight_decay, classes, model_name, train_file_path, val_file_path,
          data_dir, label_dir, target_size=target_size, batchnorm_momentum=batchnorm_momentum,
